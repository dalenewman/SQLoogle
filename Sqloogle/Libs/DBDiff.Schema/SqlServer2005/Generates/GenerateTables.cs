...
using Constraint = Sqloogle.Libs.DBDiff.Schema.SqlServer2005.Model.Constraint;
...
namespace Sqloogle.Libs.DBDiff.Schema.SqlServer2005.Generates
{
    public class GenerateTables
    {
        ...
        private int TableCreateDateIndex = -1;
        private int TableModifyDateIndex = -1;
        ...
        private void InitTableIndex(Database database, IDataRecord reader)
        {
            ...
            if (TableIdIndex == -1)
            {
                ...
                TableCreateDateIndex = reader.GetOrdinal("create_date");
                TableModifyDateIndex = reader.GetOrdinal("modify_date");
            }
        }
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (lastObjectId != (int)reader[TableIdIndex])
                            {
                                ...
                                if (isTable)
                                {
                                    ...
                                    item.CreateDate = (DateTime) reader[TableCreateDateIndex];
                                    item.ModifyDate = (DateTime) reader[TableModifyDateIndex];
